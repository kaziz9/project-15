      ...
      <div className={`w-full max-w-2xl rounded-xl shadow-2xl max-h-[90vh] overflow-y-auto ${
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center pt-4">
            <button
              onClick={handleShare}
              className={`inline-flex items-center space-x-2 px-6 py-3 rounded-lg transition-all duration-200 hover:scale-105 mb-4 ${
                darkMode 
            ...
            >
              ...
              <span className="font-medium">{t(language, 'shareApp')}</span>
            </button>
          </div>

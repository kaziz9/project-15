    ...
    <>
      ...
      <div className="p-4 md:p-6">
        ...
        <div>
          ...
          {/* Add Folder Input */}
          {showAddFolder && (
            <div className={`mb-3 p-3 rounded-lg border border-dashed ${
              darkMode ? 'border-gray-600' : 'border-gray-300'
            }`}>
              <div className="space-y-2">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 px-3 py-1.5 bg-green-600 text-white rounded-lg text-xs hover:bg-green-700 transition-colors"
                  >
                    {t(language, 'save')}
                  </button>
                  <button
